...
public class FaturamentoDAO {
	 ...
	 * @param Recebe como parametro um objeto do tipo faturamento que sera inserido no banco de dados
	 */
	 ...
	 * @param recebe como parametro um objeto do tipo faturamento que esta associado a um id que se deseja alterar
	 */
	 ...
	 * @param recebe como parametro um objeto do tipo faturamento que esta associado ao id que se deseja excluir
	 */
	 ...
	 * @param Recebe como parametro um id especifico que esta associado a um registro da tabela faturamento
	 * @return Retorna um objeto do tipo faturamento que esta associado ao id pesquisado
	 */
	 ...
	 * @return Recebe como retorno uma lista contendo todos os objetos inseridos na tabela faturamento
	 */
